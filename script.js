        ...
        <div class="card-body">
          ...
          <div class="card-price">
            <div class="price-tag price-tag--soles">
              <span class="price-logo" title="Yape">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#742A8C" stroke-width="2"><path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5"/></svg>
              </span>
              <span class="price-value">${p.priceSoles}</span>
              <span class="price-logo" title="Plin">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#00C0D4" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M8 12h8M12 8v8"/></svg>
              </span>
            </div>
            <span class="price-divider">ó</span>
            <div class="price-tag price-tag--usdt">
              <span class="price-logo" title="Binance">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="#FCD535"><path d="M16 12l-4-4-4 4 1.5 1.5L12 11l2.5 2.5L16 12zM12 4L8 8l1.5 1.5L12 7l2.5 2.5L16 8l-4-4zM12 20l4-4-1.5-1.5L12 17l-2.5-2.5L8 16l4 4zM4 12l4-4 1.5 1.5L7 12l2.5 2.5L8 16l-4-4zm16 0l-4 4-1.5-1.5L17 12l-2.5-2.5L16 8l4 4z"/></svg>
              </span>
              <span class="price-value">${p.priceUSDT}</span>
              <span class="price-logo" title="PayPal">
